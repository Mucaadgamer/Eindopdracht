...
//  Handle adding a new user when POST action is add
...
//  Handle updating an existing user when POST action is update
...
<td>
    <form class="form2" action="Users.php" method="POST">
        ...
        <button type="submit" name="delete_btn" onclick="return confirm('Weet je zeker dat je deze user wilt verwijderen?')"
